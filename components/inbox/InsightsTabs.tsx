    ...
    return (
        <div className="flex justify-between border-b border-white/10 pb-3 mb-6 sticky top-0 bg-black/20 backdrop-blur-xl z-20">
            <button
                ...
                className={`pb-3 -mb-3 font-semibold text-sm tracking-wide transition-colors ${activeTab === "insights" ? "text-teal-400 border-b-2 border-teal-400" : "text-white/40 hover:text-white"}`}
            >
                Insights
            </button>
            <button
