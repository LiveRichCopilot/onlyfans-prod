...
export default function LoginForm() {
  ...
  return (
    <div className="glass-panel p-10 rounded-3xl z-10 w-full max-w-md border-white/10 mx-4 relative">
      ...
      <p className="text-center text-white/50 mb-8">
        {mode === "signin" ? t("signInToAccount") : t("createAccount")}
      </p>

      <button
        onClick={handleGoogleSignIn}
        className="w-full py-3 rounded-xl font-semibold text-lg bg-white text-black hover:bg-white/90 transition-all flex items-center justify-center gap-3"
      >
