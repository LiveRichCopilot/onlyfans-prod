...
const CATEGORIES = [
  { key: "sla", label: "SLA", max: 25, color: CHART_COLORS.blue },
  { key: "followup", label: "Follow-up", max: 20, color: CHART_COLORS.teal },
  { key: "trigger", label: "Triggers", max: 20, color: CHART_COLORS.purple },
  { key: "quality", label: "Quality", max: 20, color: CHART_COLORS.amber },
  { key: "revenue", label: "Revenue", max: 15, color: CHART_COLORS.emerald },
];
    ...
    <div className="glass-card rounded-3xl p-6">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p className="text-white/40 text-xs mt-0.5">Team average by category</p>
        </div>
